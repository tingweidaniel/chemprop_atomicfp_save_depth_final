...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--init_lr', type=float, default=1*1e-4,
                        help='Initial learning rate')
    parser.add_argument('--max_lr', type=float, default=1*1e-3,
                        help='Maximum learning rate')
    parser.add_argument('--final_lr', type=float, default=5*1e-5,
